...
function gemport() {
    ...
    show(`display current-configuration section global`);
}
...
ont add ${d.port} ${d.ont} sn-auth ${d.sn} omci ont-lineprofile-id 10 ont-srvprofile-id 10 desc ${d.id}
...
ont add ${d.port} ${d.ont} sn-auth ${d.sn} omci ont-lineprofile-id 1 ont-srvprofile-id 1 desc ${d.id}
...
service-port ${d.service} vlan ${d.vlan} gpon 0/${d.slot}/${d.port} ont ${d.ont} gemport 2 multi-service user-vlan ${d.vlan} tag-transform translate inbound traffic-table index 7 outbound traffic-table index 7
...
ont add ${d.port} ${d.ont} sn-auth ${d.sn} omci ont-lineprofile-id ${d.profileId || 10} ont-srvprofile-id 1111 desc ${d.id}
...
ont add ${d.port} ${d.ont} sn-auth ${d.sn} omci ont-lineprofile-id 20 ont-srvprofile-id 20 desc ${d.id}

quit

service-port ${d.service} vlan ${d.vlan} gpon 0/${d.slot}/${d.port} ont ${d.ont} gemport 4 multi-service user-vlan ${d.vlan} tag-transform translate inbound traffic-table index 6 outbound traffic-table index 6  
...
display ont wan-info 0/${d.slot} ${d.port} ${d.ont}
...
ont modify ${d.port} ${d.ont} sn ${d.sn}

ont modify ${d.port} ${d.ont} desc ${d.id}
